"""cookie_cutter_demo file for ensuring the package is executable
as `cookie_cutter_demo` and `python -m cookie_cutter_demo`
"""
import importlib
...
def _find_run_command(package_name):
    try:
        test_package_name = "{{ cookiecutter.python_package }} __test__"
